...
import com.tresflex.schoolapp.adapter.PastAttendanceAdapter;
...
public class PastAttendanceFragment extends BaseFragment implements View.OnClickListener {
    ...
    private void initialize() {
        ...
        if (AppPreferences.getAddStudentList(thisActivity).equals("")) {
            ...
            pastAttendanceAdapter = new PastAttendanceAdapter(thisActivity, studentList);
            takeAttendanceListView.setAdapter(pastAttendanceAdapter);
        }
    }
