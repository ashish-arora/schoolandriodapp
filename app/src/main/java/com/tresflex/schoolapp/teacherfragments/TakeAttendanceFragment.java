...
public class TakeAttendanceFragment extends BaseFragment implements TabHost.OnTabChangeListener {
    ...
    private void initializeViewPager() {
        ...
        fragments.add(Fragment.instantiate(thisActivity, PastAttendanceFragment.class.getName()));
    ...
    private void initialiseTabHost() {
        ...
        addTab.addTab(Constants.PAST_ATTENDANCE, Constants.PAST_ATTENDANCE, -1);
