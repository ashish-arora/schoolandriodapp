...
import com.tresflex.schoolapp.helper.HttpUrlConstants;
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            try {
                ...
                response = HttpRequests.postLogin(data);
                Log.d(DBConstants.TAG, "response: " + response);
                if (response) {
                    Log.d(DBConstants.TAG, "inside response ");
                    HttpRequests.parseLoginResponse(response, getApplicationContext());
                } else{
                    throw new Exception("Login Response is Null");
                }
            } catch (Exception e) {
                Log.d(DBConstants.TAG, "Error while login: " + e);
                return false;
            }
